// Ejercicio 7: Ingresar "N" enteros, visulizar la suma de los suma de los numeros pares 
// de la lsita, cuantos numeros pares existen y cual es el promedio de los 
// numeros impares
function ejercicio7() {
	...
	if (conteo_pares==0) {
		...
		document.write("El conteo de los numeros para es: ",conteo_pares,'<BR/>');
	}
	if (conteo_impares==0) {
